...
over_dict = {
    ...
    #3Follower count (0:100=0, 101:200=1, 201:300=2, 301:400=3, 401:500=4, 501:600=5, 601:700=6, 701:800=7, 801:900=8, beyond 900=9)
    'follower_int': {
        "0_bot": 0.0,
        "1_bot": 0.0,
        "2_bot": 0.0,
    ...
    #4Account has written at least 50 tweets (y, n)
    'min_tweets': {
        "has50tweets_bot": 0.0,
    ...
    #5 (2 * number of followers) >= (number of friends) (y, n)
    'follower_friend': {
    ...
    #6The bio does NOT contain the word “bot” (y,n)
    'contains_bot': {
        "hasbot_bot": 0.0,
        "hasbot_!bot": 0.0,
        "hasntbot_bot": 0.0,
    ...
    #8Friend count (0:100=0, 101:200=1, 201:300=2, 301:400=3, 401:500=4, 501:600=5, 601:700=6, 701:800=7, 801:900=8, beyond 900=9)
    'friends_int': {
        "0_bot": 0.0,
        "1_bot": 0.0,
        "2_bot": 0.0,
...
{"bot": 1090, "!bot": 1404}
'''
print("\nThis program rewrites the files that NBC_Project.py uses to analyze twitter users. This takes about 10 to 15 minutes to run depending on your machine.\n")
print("This Step shouldn't be necessary unless you want to train the model with new data and/or test it with new data.\n")
print("The NBC_Project.py file should be able to run on its own without this step. The training and testing files should already be included.\n")
...
with open('dict_perc.json', "w") as fptr:
    json.dump(over_dict, fptr)
...
print("\nBegin getting values to test the model\n") #DEBUGGING

naive_data = test_results()

with open('naive_dict.json', "w") as fptr:
    json.dump(naive_data, fptr)

fptr.close()

print("\nDone with the the test dictionary\n")
